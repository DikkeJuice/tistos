...
export const ProductShowcase = () => {
  ...
  const handlePrevious = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === 0 ? sandwiches.length - 1 : prevIndex - 1
    );
  };

  const handleNext = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === sandwiches.length - 1 ? 0 : prevIndex + 1
    );
  };
  ...
  return (
    <section className="py-24 bg-neuro-base relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center justify-center gap-8">
            <Button
              ...
              className="neuro-button absolute left-4 z-10 rounded-full"
            >
              ...
              <div className="neuro-card product-card group overflow-visible">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {Object.values(currentSandwich.allergens).some(value => value) && (
            ...
            <Button
              ...
              size="icon"
              onClick={handleNext}
              className="neuro-button absolute right-4 z-10 rounded-full"
            >
