...
export const Hero = () => {
  ...
  return <>
      <section className="relative overflow-hidden flex flex-col" style={{
      background: "#f9bd74",
          ...
          <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 relative z-10 py-24 md:py-16">
            ...
            <div className="flex items-center justify-center order-1 lg:order-2">
              <div className="relative w-full max-w-md mx-auto">
                {/* Main product image - ensure it's never cropped */}
                <div className="flex items-center justify-center">
                  <img src="/lovable-uploads/4fefac10-95b4-48cb-9830-baa771465b58.png" alt="Tosti met gesmolten kaas" className="w-auto h-auto object-contain max-w-full" style={{
            ...
            <div className="flex flex-col justify-center order-2 lg:order-1 text-center lg:text-left">
              ...
              {!isMobile && <h1 className="font-['Merriweather'] font-bold text-4xl md:text-5xl lg:text-6xl text-[#003A40] leading-tight mb-6">
                  Nooit meer saaie tosti's
                </h1>}
              ...
              <div className="hidden md:flex justify-center lg:justify-start mb-12 md:mb-8">
                <Button onClick={scrollToProductGrid} className="bg-[rgb(255,92,83)] hover:bg-[rgb(230,70,61)] text-white text-lg px-8 py-6 rounded-md shadow-md transition-all duration-300 hover:scale-105 font-['Work_Sans'] font-medium">Stel je gratis proefpakket samen</Button>
              </div>
            </div>
          </div>
        </div>
