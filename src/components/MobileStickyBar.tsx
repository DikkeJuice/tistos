    ...
    <div className="fixed bottom-0 left-0 right-0 bg-white p-4 shadow-[0_-2px_10px_rgba(0,0,0,0.1)] z-50">
      <div className="container mx-auto flex flex-col items-center">
        <Button 
          ...
          className="bg-[rgb(255,92,83)] hover:bg-[rgb(230,70,61)] text-white w-full py-5 rounded-md shadow-sm transition-colors duration-300 font-['Work_Sans'] font-medium"
        >
          Kies de box die bij je past
        </Button>
        <p className="mt-2 text-sm text-gray-600 font-['Work_Sans']">
          Nu met 50% korting op je eerste box
        </p>
      </div>
    </div>
  );
